...
.controller('RoomListCtrl', function($scope, $timeout, $firebase, $location) {
  var ref = new Firebase('https://shining-heat-9701.firebaseio.com/opened_rooms');  
...
.controller('RoomCtrl', function($scope, $stateParams, $timeout, $firebase, $location, $ionicScrollDelegate) {
  var roomRef = new Firebase('https://shining-heat-9701.firebaseio.com/opened_rooms/');
  var messagesRef = new Firebase('https://shining-heat-9701.firebaseio.com/rooms/' + $stateParams.roomId);
